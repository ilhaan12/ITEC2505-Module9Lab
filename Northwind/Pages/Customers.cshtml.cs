...
public class CustomersModel : PagesModel{
    ...
    public void OnGet(){
        ...
        string connectionString = "Server=localhost;Database=Northwind;UserId=sa;Password=P@ssword; ; TrustServerCertificate=True;";
...
public class Customer{
    //Attributes (variables that hold the values thattt describe a customer)
